...
public class Krb5
{
  ...
  public static final boolean DEFAULT_EMPTY_ADDRESSES_ALLOWED = 1;
  public static final boolean DEFAULT_FORWARDABLE_ALLOWED = 1;
  public static final boolean DEFAULT_PROXIABLE_ALLOWED = 1;
  public static final boolean DEFAULT_POSTDATE_ALLOWED = 1;
  public static final boolean DEFAULT_RENEWABLE_ALLOWED = 1;
  public static final boolean AP_EMPTY_ADDRESSES_ALLOWED = 1;
  public static final boolean KDC_EMPTY_ADDRESSES_ALLOWED = 1;
  ...
  private static Hashtable errMsgList;
  ...
  {
    return ((String)errMsgList.get(new Integer(paramInt)));
  }

  static
  {
    errMsgList = new Hashtable();
    errMsgList.put(new Integer(0), "No error");
    errMsgList.put(new Integer(1), "Client's entry in database expired");
    errMsgList.put(new Integer(2), "Server's entry in database has expired");
    errMsgList.put(new Integer(3), "Requested protocol version number not supported");
    errMsgList.put(new Integer(4), "Client's key encrypted in old master key");
    errMsgList.put(new Integer(5), "Server's key encrypted in old master key");
    errMsgList.put(new Integer(6), "Client not found in Kerberos database");
    errMsgList.put(new Integer(7), "Server not found in Kerberos database");
    errMsgList.put(new Integer(8), "Multiple principal entries in database");
    errMsgList.put(new Integer(9), "The client or server has a null key");
    errMsgList.put(new Integer(10), "Ticket not eligible for postdating");
    errMsgList.put(new Integer(11), "Requested start time is later than end time");
    errMsgList.put(new Integer(12), "KDC policy rejects request");
    errMsgList.put(new Integer(13), "KDC cannot accommodate requested option");
    errMsgList.put(new Integer(14), "KDC has no support for encryption type");
    errMsgList.put(new Integer(15), "KDC has no support for checksum type");
    errMsgList.put(new Integer(16), "KDC has no support for padata type");
    errMsgList.put(new Integer(17), "KDC has no support for transited type");
    errMsgList.put(new Integer(18), "Clients credentials have been revoked");
    errMsgList.put(new Integer(19), "Credentials for server have been revoked");
    errMsgList.put(new Integer(20), "TGT has been revoked");
    errMsgList.put(new Integer(21), "Client not yet valid - try again later");
    errMsgList.put(new Integer(22), "Server not yet valid - try again later");
    errMsgList.put(new Integer(23), "Password has expired - change password to reset");
    errMsgList.put(new Integer(24), "Pre-authentication information was invalid");
    errMsgList.put(new Integer(25), "Additional pre-authentication required");
    errMsgList.put(new Integer(31), "Integrity check on decrypted field failed");
    errMsgList.put(new Integer(32), "Ticket expired");
    errMsgList.put(new Integer(33), "Ticket not yet valid");
    errMsgList.put(new Integer(34), "Request is a replay");
    errMsgList.put(new Integer(35), "The ticket isn't for us");
    errMsgList.put(new Integer(36), "Ticket and authenticator don't match");
    errMsgList.put(new Integer(37), "Clock skew too great");
    ...
    errMsgList.put(new Integer(44), "Specified version of key is not available");
    errMsgList.put(new Integer(45), "Service key not available");
    errMsgList.put(new Integer(46), "Mutual authentication failed");
    errMsgList.put(new Integer(47), "Incorrect message direction");
    errMsgList.put(new Integer(48), "Alternative authentication method required");
    errMsgList.put(new Integer(49), "Incorrect sequence number in message");
    errMsgList.put(new Integer(50), "Inappropriate type of checksum in message");
    errMsgList.put(new Integer(52), "Response too big for UDP, retry with TCP");
    errMsgList.put(new Integer(60), "Generic error (description in e-text)");
    errMsgList.put(new Integer(61), "Field is too long for this implementation");
    errMsgList.put(new Integer(62), "Realm name not available");
    errMsgList.put(new Integer(400), "Invalid argument");
    errMsgList.put(new Integer(500), "BitString size does not match input byte array");
    errMsgList.put(new Integer(501), "BitString bit index does not fall within size");
    errMsgList.put(new Integer(502), "BitString length is wrong for the expected type");
    errMsgList.put(new Integer(600), "");
    errMsgList.put(new Integer(601), "Null realm name");
    errMsgList.put(new Integer(900), "Input not in GeneralizedTime format");
    errMsgList.put(new Integer(901), "Structure is missing a required field");
    errMsgList.put(new Integer(902), "Unexpected field number");
    errMsgList.put(new Integer(903), "Type numbers are inconsistent");
    errMsgList.put(new Integer(904), "Value too large");
    errMsgList.put(new Integer(905), "Encoding ended unexpectedly");
    errMsgList.put(new Integer(906), "Identifier doesn't match expected value");
    errMsgList.put(new Integer(907), "Length doesn't match expected value");
    errMsgList.put(new Integer(908), "Badly-formatted encoding");
    errMsgList.put(new Integer(909), "Parse error");
    errMsgList.put(new Integer(910), "Bad class number");
    errMsgList.put(new Integer(911), "Bad type number");
    errMsgList.put(new Integer(912), "Bad tag number");
    errMsgList.put(new Integer(913), "Unsupported ASN.1 type encountered");
    errMsgList.put(new Integer(914), "Encoding failed due to invalid parameter(s)");
    errMsgList.put(new Integer(100), "Client has no support for crypto type");
    errMsgList.put(new Integer(101), "Invalid option setting in ticket request.");
    errMsgList.put(new Integer(63), "Fail to create credential.");
  }
}