...
public final class ParameterCache
{
  ...
  {
    return ((DSAParameterSpec)dsaCache.get(Integer.valueOf(paramInt)));
  }
  ...
  {
    DSAParameterSpec localDSAParameterSpec = getCachedDSAParameterSpec(paramInt);
    if (localDSAParameterSpec != null)
      return localDSAParameterSpec;
    localDSAParameterSpec = getNewDSAParameterSpec(paramInt, paramSecureRandom);
    dsaCache.put(Integer.valueOf(paramInt), localDSAParameterSpec);
    return localDSAParameterSpec;
  }
  ...
  static
  {
    ...
    dsaCache.put(Integer.valueOf(512), new DSAParameterSpec(localBigInteger1, localBigInteger2, localBigInteger3));
    dsaCache.put(Integer.valueOf(768), new DSAParameterSpec(localBigInteger4, localBigInteger5, localBigInteger6));
    dsaCache.put(Integer.valueOf(1024), new DSAParameterSpec(localBigInteger7, localBigInteger8, localBigInteger9));
