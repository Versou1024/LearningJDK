  ...
  implements CertAttrSet
{
    ...
    throws IOException
  {
    ...
    if (this.notBefore.getTime() < 2524636800000L)
      localDerOutputStream1.putUTCTime(this.notBefore);
    else
      localDerOutputStream1.putGeneralizedTime(this.notBefore);
    if (this.notAfter.getTime() < 2524636800000L)
      localDerOutputStream1.putUTCTime(this.notAfter);
    else
      localDerOutputStream1.putGeneralizedTime(this.notAfter);
