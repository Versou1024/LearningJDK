...
public final class SunProvider extends Provider
{
  ...
  public SunProvider()
  {
    super("SunJGSS", 1D, "Sun (Kerberos v5, SPNEGO)");
    AccessController.doPrivileged(new PrivilegedAction(this)
    {
      public Object run()
      {
        this.this$0.put("GssApiMechanism.1.2.840.113554.1.2.2", "sun.security.jgss.krb5.Krb5MechFactory");
        this.this$0.put("GssApiMechanism.1.3.6.1.5.5.2", "sun.security.jgss.spnego.SpNegoMechFactory");
        return null;
      }
    });
  }
