...
public abstract class Validator
{
  ...
  public static Validator getInstance(String paramString1, String paramString2, Collection paramCollection)
  {
  ...
  public final X509Certificate[] validate(X509Certificate[] paramArrayOfX509Certificate, Collection paramCollection)
    throws CertificateException
  {
    return validate(paramArrayOfX509Certificate, paramCollection, null);
  }

  public final X509Certificate[] validate(X509Certificate[] paramArrayOfX509Certificate, Collection paramCollection, Object paramObject)
    throws CertificateException
  {
    paramArrayOfX509Certificate = engineValidate(paramArrayOfX509Certificate, paramCollection, paramObject);
  ...
  abstract X509Certificate[] engineValidate(X509Certificate[] paramArrayOfX509Certificate, Collection paramCollection, Object paramObject)
    throws CertificateException;
