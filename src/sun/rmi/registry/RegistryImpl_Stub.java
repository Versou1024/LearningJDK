  ...
  implements Registry, Remote
{
  ...
  {
    RemoteCall localRemoteCall;
    try
    {
      localRemoteCall = this.ref.newCall(this, operations, 0, 4905912898345647071L);
      try
      {
    ...
    throws AccessException, RemoteException
  {
    ...
    try
    {
      ...
      localRemoteCall = this.ref.newCall(this, operations, 1, 4905912898345647071L);
      this.ref.invoke(localRemoteCall);
      try
      {
    ...
    throws AccessException, NotBoundException, RemoteException
  {
    ...
    {
      Remote localRemote;
      localRemoteCall = this.ref.newCall(this, operations, 2, 4905912898345647071L);
      try
      {
        ObjectOutput localObjectOutput = localRemoteCall.getOutputStream();
        localObjectOutput.writeObject(paramString);
    ...
    throws AccessException, RemoteException
  {
    ...
    try
    {
      localRemoteCall = this.ref.newCall(this, operations, 3, 4905912898345647071L);
      try
      {
        ObjectOutput localObjectOutput = localRemoteCall.getOutputStream();
        localObjectOutput.writeObject(paramString);
    ...
    throws AccessException, NotBoundException, RemoteException
  {
    ...
    try
    {
      localRemoteCall = this.ref.newCall(this, operations, 4, 4905912898345647071L);
      try
      {
        ObjectOutput localObjectOutput = localRemoteCall.getOutputStream();
        localObjectOutput.writeObject(paramString);
