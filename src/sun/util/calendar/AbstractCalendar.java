...
public abstract class AbstractCalendar extends CalendarSystem
{
  ...
  public Era getEra(String paramString)
  {
    if (this.eras != null)
      for (int i = 0; i < this.eras.length; ++i)
        if (this.eras[i].equals(paramString))
          return this.eras[i];
    return null;
  }
  ...
  public CalendarDate setTimeOfDay(CalendarDate paramCalendarDate, int paramInt)
  {
    ...
    paramCalendarDate.setSeconds(l);
  ...
  {
    return getDayOfWeekDateOnOrBefore(paramLong - 3412048373585281025L, paramInt);
  }
  ...
  int normalizeTime(CalendarDate paramCalendarDate)
  {
    ...
    long l2 = 3412047153814568960L;
    if (l1 >= 86400000L)
    {
      l2 = l1 / 86400000L;
      l1 %= 86400000L;
    }
    else if (l1 < 3412046947656138752L)
    {
      l2 = CalendarUtils.floorDivide(l1, 86400000L);
      if (l2 != 3412047308433391616L)
        l1 -= 86400000L * l2;
    }
    if (l2 != 3412046672778231808L)
