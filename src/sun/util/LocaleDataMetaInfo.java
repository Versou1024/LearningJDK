...
public class LocaleDataMetaInfo
{
  ...
  static
  {
    ...
    resourceNameToLocales.put("sun.text.resources.CollationData", "  be bg ca cs da de el en es et fi fr hr hu is it lt lv mk nl no pl pt ro ru sk sl sq sr sv tr uk |  ar hi iw ja ko th vi zh zh_HK zh_TW ");
    resourceNameToLocales.put("sun.util.resources.TimeZoneNames", "  de en en_CA en_GB en_IE es fr it sv |  hi ja ko zh_CN zh_HK zh_TW ");
    resourceNameToLocales.put("sun.util.resources.LocaleNames", "  be bg ca cs da de el el_CY en en_MT en_PH en_SG es es_US et fi fr ga hr hu in is it lt lv mk ms mt nl no pl pt pt_BR pt_PT ro ru sk sl sq sr sv tr uk |  ar hi iw ja ko th vi zh zh_HK zh_SG zh_TW ");
    ...
    resourceNameToLocales.put("sun.util.resources.CalendarData", "  be bg ca cs da de el el_CY en en_GB en_IE en_MT es es_ES es_US et fi fr fr_CA hr hu in_ID is it lt lv mk ms_MY mt mt_MT nl no pl pt pt_PT ro ru sk sl sq sr sv tr uk |  ar hi iw ja ko th vi zh ");
  }
}