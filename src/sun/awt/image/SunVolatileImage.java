  ...
  implements DestSurfaceProvider
{
  ...
  public void updateGraphicsConfig()
  {
    if (this.comp != null)
    {
      GraphicsConfiguration localGraphicsConfiguration = this.comp.getGraphicsConfiguration();
      if (localGraphicsConfiguration != null)
        this.graphicsConfig = localGraphicsConfiguration;
    }
  }
  ...
  {
    if ((this.graphicsConfig instanceof BufferedImageGraphicsConfig) || (this.graphicsConfig instanceof PrinterGraphicsConfig) || ((paramImageCapabilities != null) && (!(paramImageCapabilities.isAccelerated()))))
  ...
  {
    ColorModel localColorModel = this.graphicsConfig.getColorModel(getTransparency());
    WritableRaster localWritableRaster = localColorModel.createCompatibleWritableRaster(getWidth(), getHeight());
  ...
  {
    return this.volSurfaceManager.validate(paramGraphicsConfiguration);
  }
  ...
  {
    return this.volSurfaceManager.getDestSurfaceData();
  }
}