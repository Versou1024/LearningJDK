...
final class Order0 extends Curve
{
  ...
  {
    return ((this.x > paramCrossings.getXLo()) && (this.x < paramCrossings.getXHi()) && (this.y > paramCrossings.getYLo()) && (this.y < paramCrossings.getYHi()));
  }

  public void enlarge(Rectangle2D paramRectangle2D)
  {
    paramRectangle2D.add(this.x, this.y);
  }
