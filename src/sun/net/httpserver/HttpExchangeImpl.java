...
class HttpExchangeImpl extends HttpExchange
{
  ...
  public void sendResponseHeaders(int paramInt, long paramLong)
    throws IOException
  {
    this.impl.sendResponseHeaders(paramInt, paramLong);
  }
  ...
  {
    return this.impl.getAttribute(paramString);
  }

  public void setAttribute(String paramString, Object paramObject)
  {
    this.impl.setAttribute(paramString, paramObject);
  }

  public void setStreams(InputStream paramInputStream, OutputStream paramOutputStream)
  {
    this.impl.setStreams(paramInputStream, paramOutputStream);
  }
