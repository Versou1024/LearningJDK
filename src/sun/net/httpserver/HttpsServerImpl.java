...
public class HttpsServerImpl extends HttpsServer
{
  ...
  HttpsServerImpl(InetSocketAddress paramInetSocketAddress, int paramInt)
    throws IOException
  {
    this.server = new ServerImpl(this, "https", paramInetSocketAddress, paramInt);
  }

  public void setHttpsConfigurator(HttpsConfigurator paramHttpsConfigurator)
  {
    this.server.setHttpsConfigurator(paramHttpsConfigurator);
  }
  ...
  public void bind(InetSocketAddress paramInetSocketAddress, int paramInt)
    throws IOException
  {
    this.server.bind(paramInetSocketAddress, paramInt);
  }
  ...
  {
    this.server.setExecutor(paramExecutor);
  }
