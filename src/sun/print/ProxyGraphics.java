...
public class ProxyGraphics extends Graphics
{
  ...
  {
    return new ProxyGraphics(this.g.create(paramInt1, paramInt2, paramInt3, paramInt4));
  }

  public void translate(int paramInt1, int paramInt2)
  {
    this.g.translate(paramInt1, paramInt2);
  }
  ...
  {
    this.g.clipRect(paramInt1, paramInt2, paramInt3, paramInt4);
  }

  public void setClip(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    this.g.setClip(paramInt1, paramInt2, paramInt3, paramInt4);
  }
  ...
  {
    this.g.clearRect(paramInt1, paramInt2, paramInt3, paramInt4);
  }
  ...
  {
    return this.g.drawImage(paramImage, paramInt1, paramInt2, paramInt3, paramInt4, paramImageObserver);
  }

  public boolean drawImage(Image paramImage, int paramInt1, int paramInt2, Color paramColor, ImageObserver paramImageObserver)
  {
    return this.g.drawImage(paramImage, paramInt1, paramInt2, paramColor, paramImageObserver);
  }
  ...
  {
    return this.g.drawImage(paramImage, paramInt1, paramInt2, paramInt3, paramInt4, paramColor, paramImageObserver);
  }
  ...
  {
    return this.g.drawImage(paramImage, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramInt7, paramInt8, paramImageObserver);
  }
  ...
  {
    return this.g.drawImage(paramImage, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramInt7, paramInt8, paramColor, paramImageObserver);
  }
  ...
  {
    return this.g.hitClip(paramInt1, paramInt2, paramInt3, paramInt4);
  }

  public Rectangle getClipBounds(Rectangle paramRectangle)
  {
    return this.g.getClipBounds(paramRectangle);
  }
}