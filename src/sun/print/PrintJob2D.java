  ...
  implements Printable, Runnable
{
  ...
  private void initPrintJob2D(Frame paramFrame, String paramString, JobAttributes paramJobAttributes, PageAttributes paramPageAttributes)
  {
    ...
    JobAttributes.DestinationType localDestinationType = this.jobAttributes.getDestination();
  ...
  public boolean printDialog()
  {
    ...
    if (this.printerJob == null)
      return false;
    JobAttributes.DialogType localDialogType = this.jobAttributes.getDialog();
    PrintService localPrintService = this.printerJob.getPrintService();
    if ((localPrintService == null) && (localDialogType == JobAttributes.DialogType.NONE))
      return false;
    copyAttributes(localPrintService);
    JobAttributes.DefaultSelectionType localDefaultSelectionType = this.jobAttributes.getDefaultSelection();
    ...
    else
    {
      ...
      if ((bool = this.printerJob.printDialog(this.attributes)))
      {
        ...
        {
          localPrintService = this.printerJob.getPrintService();
          if (localPrintService == null)
            return false;
        }
        updateAttributes();
    ...
    if (bool)
    {
      ...
      if (localJobName != null)
        this.printerJob.setJobName(localJobName.toString());
      ...
      Paper localPaper = this.pageFormat.getPaper();
      ...
      if (this.pageAttributes.getOrigin() == PageAttributes.OriginType.PRINTABLE)
        ...
        localPaper.setImageableArea(0D, 0D, localPaper.getWidth(), localPaper.getHeight());
      this.pageFormat.setPaper(localPaper);
      OrientationRequested localOrientationRequested = (OrientationRequested)this.attributes.get(OrientationRequested.class);
      ...
      this.jobAttributes.setPrinter(localPrintService.getName());
  ...
  private void updateAttributes()
  {
    ...
    this.jobAttributes.setCopies(localCopies.getValue());
    ...
    if (localDestination != null)
    {
      ...
      this.jobAttributes.setFileName(localDestination.getURI().getPath());
    }
    else
    {
    ...
    SheetCollate localSheetCollate = (SheetCollate)this.attributes.get(SheetCollate.class);
    ...
    Sides localSides = (Sides)this.attributes.get(Sides.class);
    ...
    Chromaticity localChromaticity = (Chromaticity)this.attributes.get(Chromaticity.class);
    ...
    PrintQuality localPrintQuality = (PrintQuality)this.attributes.get(PrintQuality.class);
    ...
    if ((localMedia != null) && (localMedia instanceof MediaSizeName))
    {
      ...
      if (localMediaType != null)
        this.pageAttributes.setMedia(localMediaType);
    }
  ...
  private void copyAttributes(PrintService paramPrintService)
  {
    ...
    if ((str != null) && (str != "") && (!(str.equals(localPrintService.getName()))))
    {
      ...
      try
      {
        for (int i = 0; i < localObject1.length; ++i)
          ...
          {
            this.printerJob.setPrintService(localObject1[i]);
    ...
    Object localObject1 = this.jobAttributes.getDestination();
    if ((localObject1 == JobAttributes.DestinationType.FILE) && (localPrintService.isAttributeCategorySupported(Destination.class)))
    {
      localObject2 = this.jobAttributes.getFileName();
      if (localObject2 == null)
      {
        if ((localObject3 = (Destination)localPrintService.getDefaultAttributeValue(Destination.class)) != null)
          this.attributes.add((Attribute)localObject3);
      }
      else
      {
        localObject4 = null;
        ...
        if (localObject4 != null)
          this.attributes.add(new Destination((URI)localObject4));
      }
    }
    this.attributes.add(new SunMinMaxPage(this.jobAttributes.getMinPage(), this.jobAttributes.getMaxPage()));
    Object localObject2 = this.jobAttributes.getSides();
    ...
    Object localObject3 = this.jobAttributes.getMultipleDocumentHandling();
    ...
    Object localObject4 = this.pageAttributes.getMedia();
    ...
    PageAttributes.PrintQualityType localPrintQualityType = this.pageAttributes.getPrintQuality();
  ...
  public Graphics getGraphics()
  {
    ...
    if (this.currentGraphics != null)
    {
      ...
      localProxyPrintGraphics = new ProxyPrintGraphics(this.currentGraphics.create(), this);
    }
  ...
  private void translateOutputProps()
  {
    ...
    PageAttributes.MediaType localMediaType = SIZES[this.pageAttributes.getMedia().hashCode()];
  ...
  private class MessageQ
  {
    ...
    {
      label0: if ((this.queue != null) && (this.queue.size() > 0));
      try
      {
        super.wait(1000L);
      }
    ...
    synchronized boolean append()
    {
      ...
      if (this.queue != null)
      {
        this.queue.add(paramGraphics2D);
        i = 1;
        super.notify();
      }
      return i;
    ...
    synchronized Graphics2D pop()
    {
      ...
      while (true)
      {
        if ((localGraphics2D != null) || (this.queue == null))
          break label56;
        if (this.queue.size() <= 0)
          break;
        localGraphics2D = (Graphics2D)this.queue.remove(0);
        super.notify();
      }
      try
      {
      ...
      label56: return localGraphics2D;
    }
