  ...
  implements PropertyEditor
{
    ...
    throws IllegalArgumentException
  {
    ...
    int j = paramString.indexOf(44, i + 1);
    if ((i < 0) || (j < 0))
      throw new IllegalArgumentException(paramString);
    try
    {
      int k = Integer.parseInt(paramString.substring(0, i));
      int l = Integer.parseInt(paramString.substring(i + 1, j));
      int i1 = Integer.parseInt(paramString.substring(j + 1));
      Color localColor = new Color(k, l, i1);
      changeColor(localColor);
    }
