...
public final class ScriptRun
{
    ...
    while ((j = nextCodePoint()) != -1)
    {
      ...
      if (l >= 0)
        if ((l & 0x1) == 0)
        {
          ...
          this.stack[(this.parenSP++)] = l;
          this.stack[(this.parenSP++)] = this.scriptCode;
        }
        else if (this.parenSP > 0)
        {
          int i1 = l & 0xFFFFFFFE;
          while ((this.parenSP -= 2 >= 0) && (this.stack[this.parenSP] != i1));
          if (this.parenSP >= 0)
  ...
  private final int nextCodePoint()
  {
    if (this.scriptLimit >= this.textLimit)
      return -1;
    int i = this.text[(this.scriptLimit++)];
    if ((i >= 55296) && (i < 56320) && (this.scriptLimit < this.textLimit))
    {
      int j = this.text[this.scriptLimit];
      if ((j >= 56320) && (j < 57344))
      {
        this.scriptLimit += 1;
        i = (i << 10) + j + -56613888;
  ...
  private static int getPairIndex(int paramInt)
  {
    ...
    while (true)
    {
      ...
      while (paramInt < pairedChars[(j + i)]);
      j += i;
    }
