  ...
  implements TextLineComponent, Decoration.Label
{
  ...
  {
    Rectangle2D localRectangle2D = this.graphic.getBounds();
    float f = (float)localRectangle2D.getWidth() + this.graphicAdvance * (this.graphicCount - 1);
  ...
  {
    return new CoreMetrics(paramGraphicAttribute.getAscent(), paramGraphicAttribute.getDescent(), 2F, paramGraphicAttribute.getAscent() + paramGraphicAttribute.getDescent() + 2F, paramGraphicAttribute.getAlignment(), new float[] { 0F, -paramGraphicAttribute.getAscent() / 2F, -paramGraphicAttribute.getAscent() }, -paramGraphicAttribute.getAscent() / 2F, paramGraphicAttribute.getAscent() / 12.0F, paramGraphicAttribute.getDescent() / 3.0F, paramGraphicAttribute.getAscent() / 12.0F, 0F, 0F);
  }
  ...
  public Rectangle2D getVisualBounds()
  {
    ...
    localFloat.setRect(this.visualBounds);
    return localFloat;
  }

  public Shape handleGetOutline(float paramFloat1, float paramFloat2)
  {
    double[] arrayOfDouble = { 1D, 0D, 0D, 1D, paramFloat1, paramFloat2 };
    if (this.graphicCount == 1)
    {
      localObject = new AffineTransform(arrayOfDouble);
      return this.graphic.getOutline((AffineTransform)localObject);
    }
    ...
    for (int i = 0; i < this.graphicCount; ++i)
    {
      ...
      ((GeneralPath)localObject).append(this.graphic.getOutline(localAffineTransform), false);
      arrayOfDouble[4] += this.graphicAdvance;
    }
  ...
  {
    return this.decorator.getCharVisualBounds(this, paramInt);
  }
  ...
  public Rectangle2D handleGetCharVisualBounds(int paramInt)
  {
    ...
    localFloat.x += this.graphicAdvance * paramInt;
    return localFloat;
  }
  ...
  {
    return (this.graphicAdvance * (paramInt2 - paramInt1));
  }
  ...
  public TextLineComponent getSubset(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if ((paramInt1 == 0) && (paramInt2 == this.graphicCount) && (paramInt3 == 2))
      return this;
  ...
  {
    return "[graphic=" + this.graphic + ":count=" + getNumCharacters() + "]";
  }
