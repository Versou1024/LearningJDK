  ...
  implements Shape
{
  ...
  {
    return this.delegate.contains(paramDouble1, paramDouble2);
  }

  public boolean contains(Point2D paramPoint2D)
  {
    return this.delegate.contains(paramPoint2D);
  }

  public boolean intersects(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4)
  {
    return this.delegate.intersects(paramDouble1, paramDouble2, paramDouble3, paramDouble4);
  }

  public boolean intersects(Rectangle2D paramRectangle2D)
  {
    return this.delegate.intersects(paramRectangle2D);
  }

  public boolean contains(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4)
  {
    return this.delegate.contains(paramDouble1, paramDouble2, paramDouble3, paramDouble4);
  }

  public boolean contains(Rectangle2D paramRectangle2D)
  {
    return this.delegate.contains(paramRectangle2D);
  }

  public PathIterator getPathIterator(AffineTransform paramAffineTransform)
  {
    return this.delegate.getPathIterator(paramAffineTransform);
  }

  public PathIterator getPathIterator(AffineTransform paramAffineTransform, double paramDouble)
  {
    return this.delegate.getPathIterator(paramAffineTransform, paramDouble);
  }
}