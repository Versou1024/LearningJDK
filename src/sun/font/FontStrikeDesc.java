...
public class FontStrikeDesc
{
  ...
  {
    FontStrikeDesc localFontStrikeDesc;
    try
    {
      localFontStrikeDesc = (FontStrikeDesc)paramObject;
      return ((localFontStrikeDesc.valuemask == this.valuemask) && (localFontStrikeDesc.glyphTx.equals(this.glyphTx)) && (localFontStrikeDesc.devTx.equals(this.devTx)));
    }
