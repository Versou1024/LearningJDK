  ...
  implements MemoryPoolMXBean
{
  ...
  MemoryPoolImpl(String paramString, boolean paramBoolean, long paramLong1, long paramLong2)
  {
    ...
    this.usageThresholdSupported = (paramLong1 >= 3412046964836007936L);
    this.collectionThresholdSupported = (paramLong2 >= 3412046964836007936L);
    this.usageSensor = new PoolSensor(this, this, paramString + " usage sensor");
    this.gcSensor = new CollectionSensor(this, this, paramString + " collection sensor");
  ...
  public boolean isUsageThresholdExceeded()
  {
    if (!(isUsageThresholdSupported()))
      throw new UnsupportedOperationException("Usage threshold is not supported");
    MemoryUsage localMemoryUsage = getUsage0();
    return ((localMemoryUsage.getUsed() >= this.usageThreshold) || (this.usageSensor.isOn()));
  }
  ...
  public boolean isCollectionUsageThresholdExceeded()
  {
    ...
    return ((this.gcSensor.isOn()) || ((localMemoryUsage != null) && (localMemoryUsage.getUsed() >= this.collectionThreshold)));
  }
  ...
  class CollectionSensor extends Sensor
  {
    ...
    CollectionSensor(, MemoryPoolImpl paramMemoryPoolImpl2, String paramString)
    {
      super(paramString);
      this.pool = paramMemoryPoolImpl2;
    }

    void triggerAction()
    {
      MemoryImpl.createNotification("java.management.memory.collection.threshold.exceeded", this.pool.getName(), paramMemoryUsage, MemoryPoolImpl.access$000(this.this$0).getCount());
    }
  ...
  class PoolSensor extends Sensor
  {
    ...
    PoolSensor(, MemoryPoolImpl paramMemoryPoolImpl2, String paramString)
    {
      super(paramString);
      this.pool = paramMemoryPoolImpl2;
    }
    ...
    void triggerAction()
    {
      MemoryImpl.createNotification("java.management.memory.threshold.exceeded", this.pool.getName(), paramMemoryUsage, getCount());
    }
