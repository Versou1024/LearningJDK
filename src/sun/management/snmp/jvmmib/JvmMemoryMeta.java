  ...
  implements Serializable, SnmpStandardMetaServer
{
  ...
  public boolean skipVariable(long paramLong, Object paramObject, int paramInt)
  {
    ...
    label79: return super.skipVariable(paramLong, paramObject, paramInt);
  }
  ...
  {
    return new JvmMemMgrPoolRelTableMeta(paramSnmpMib, this.objectserver);
  }
  ...
  {
    return new JvmMemPoolTableMeta(paramSnmpMib, this.objectserver);
  }
  ...
  {
    return new JvmMemGCTableMeta(paramSnmpMib, this.objectserver);
  }
  ...
  {
    return new JvmMemManagerTableMeta(paramSnmpMib, this.objectserver);
  }
}