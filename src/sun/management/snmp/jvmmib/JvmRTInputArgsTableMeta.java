  ...
  implements Serializable
{
  ...
  {
    return new JvmRTInputArgsEntryMeta(paramSnmpMib, this.objectserver);
  }
  ...
  {
    this.node = createJvmRTInputArgsEntryMetaNode("JvmRTInputArgsEntry", "JvmRTInputArgsTable", paramSnmpMib, paramMBeanServer);
  }
    ...
    throws SnmpStatusException
  {
    ...
    synchronized (this)
    {
      this.node.setInstance(localJvmRTInputArgsEntryMBean);
  ...
  {
    JvmRTInputArgsEntryMBean localJvmRTInputArgsEntryMBean;
    try
    {
      localJvmRTInputArgsEntryMBean = (JvmRTInputArgsEntryMBean)getEntry(paramSnmpOid);
      synchronized (this)
      {
        this.node.setInstance(localJvmRTInputArgsEntryMBean);
