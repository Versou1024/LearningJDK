  ...
  implements Serializable
{
  ...
  {
    return new JvmRTClassPathEntryMeta(paramSnmpMib, this.objectserver);
  }
  ...
  {
    this.node = createJvmRTClassPathEntryMetaNode("JvmRTClassPathEntry", "JvmRTClassPathTable", paramSnmpMib, paramMBeanServer);
  }
    ...
    throws SnmpStatusException
  {
    ...
    synchronized (this)
    {
      this.node.setInstance(localJvmRTClassPathEntryMBean);
  ...
  {
    JvmRTClassPathEntryMBean localJvmRTClassPathEntryMBean;
    try
    {
      localJvmRTClassPathEntryMBean = (JvmRTClassPathEntryMBean)getEntry(paramSnmpOid);
      synchronized (this)
      {
        this.node.setInstance(localJvmRTClassPathEntryMBean);
