  ...
  implements Serializable
{
  ...
  {
    return new JvmMemManagerEntryMeta(paramSnmpMib, this.objectserver);
  }
  ...
  {
    this.node = createJvmMemManagerEntryMetaNode("JvmMemManagerEntry", "JvmMemManagerTable", paramSnmpMib, paramMBeanServer);
  }
    ...
    throws SnmpStatusException
  {
    ...
    synchronized (this)
    {
      this.node.setInstance(localJvmMemManagerEntryMBean);
  ...
  {
    JvmMemManagerEntryMBean localJvmMemManagerEntryMBean;
    try
    {
      localJvmMemManagerEntryMBean = (JvmMemManagerEntryMBean)getEntry(paramSnmpOid);
      synchronized (this)
      {
        this.node.setInstance(localJvmMemManagerEntryMBean);
