  ...
  implements Serializable
{
  ...
  {
    return new JvmMemGCEntryMeta(paramSnmpMib, this.objectserver);
  }
  ...
  {
    this.node = createJvmMemGCEntryMetaNode("JvmMemGCEntry", "JvmMemGCTable", paramSnmpMib, paramMBeanServer);
  }
    ...
    throws SnmpStatusException
  {
    ...
    synchronized (this)
    {
      this.node.setInstance(localJvmMemGCEntryMBean);
  ...
  {
    JvmMemGCEntryMBean localJvmMemGCEntryMBean;
    try
    {
      localJvmMemGCEntryMBean = (JvmMemGCEntryMBean)getEntry(paramSnmpOid);
      synchronized (this)
      {
        this.node.setInstance(localJvmMemGCEntryMBean);
