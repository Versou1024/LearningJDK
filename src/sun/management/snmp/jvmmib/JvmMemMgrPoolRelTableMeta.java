  ...
  implements Serializable
{
  ...
  {
    return new JvmMemMgrPoolRelEntryMeta(paramSnmpMib, this.objectserver);
  }
  ...
  {
    this.node = createJvmMemMgrPoolRelEntryMetaNode("JvmMemMgrPoolRelEntry", "JvmMemMgrPoolRelTable", paramSnmpMib, paramMBeanServer);
  }
    ...
    throws SnmpStatusException
  {
    ...
    synchronized (this)
    {
      this.node.setInstance(localJvmMemMgrPoolRelEntryMBean);
  ...
  {
    JvmMemMgrPoolRelEntryMBean localJvmMemMgrPoolRelEntryMBean;
    try
    {
      localJvmMemMgrPoolRelEntryMBean = (JvmMemMgrPoolRelEntryMBean)getEntry(paramSnmpOid);
      synchronized (this)
      {
        this.node.setInstance(localJvmMemMgrPoolRelEntryMBean);
