  ...
  implements Serializable
{
  ...
  {
    return new JvmRTLibraryPathEntryMeta(paramSnmpMib, this.objectserver);
  }
  ...
  {
    this.node = createJvmRTLibraryPathEntryMetaNode("JvmRTLibraryPathEntry", "JvmRTLibraryPathTable", paramSnmpMib, paramMBeanServer);
  }
    ...
    throws SnmpStatusException
  {
    ...
    synchronized (this)
    {
      this.node.setInstance(localJvmRTLibraryPathEntryMBean);
  ...
  {
    JvmRTLibraryPathEntryMBean localJvmRTLibraryPathEntryMBean;
    try
    {
      localJvmRTLibraryPathEntryMBean = (JvmRTLibraryPathEntryMBean)getEntry(paramSnmpOid);
      synchronized (this)
      {
        this.node.setInstance(localJvmRTLibraryPathEntryMBean);
