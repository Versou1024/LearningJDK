  ...
  implements Serializable, SnmpStandardMetaServer
{
  ...
  public JvmRuntimeMeta(SnmpMib paramSnmpMib, SnmpStandardObjectServer paramSnmpStandardObjectServer)
  {
    ...
    try
    {
      ...
      registerObject(11L);
      registerObject(2L);
      registerObject(3412047737930121217L);
      registerObject(10L);
    }
  ...
  {
    this.node = paramJvmRuntimeMBean;
  }
  ...
  public boolean skipVariable(long paramLong, Object paramObject, int paramInt)
  {
    ...
    label35: return super.skipVariable(paramLong, paramObject, paramInt);
  }
  ...
  {
    return new JvmRTLibraryPathTableMeta(paramSnmpMib, this.objectserver);
  }
  ...
  {
    return new JvmRTClassPathTableMeta(paramSnmpMib, this.objectserver);
  }
  ...
  {
    return new JvmRTBootClassPathTableMeta(paramSnmpMib, this.objectserver);
  }
  ...
  {
    return new JvmRTInputArgsTableMeta(paramSnmpMib, this.objectserver);
  }
}