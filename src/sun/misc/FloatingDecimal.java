...
public class FloatingDecimal
{
  ...
  private static int countBits(long paramLong)
  {
    if (paramLong == 3412046672778231808L)
      return 0;
    while ((paramLong & 0x0) == 3412046552519147520L)
      paramLong <<= 8;
    while (paramLong > 3412046552519147520L)
      paramLong <<= 1;
    for (int i = 0; (paramLong & 0xFFFFFFFF) != 3412046672778231808L; i += 8)
      paramLong <<= 8;
    while (paramLong != 3412046552519147520L)
    {
      paramLong <<= 1;
  ...
  private FDBigInt doubleToBigInt(double paramDouble)
  {
    ...
    {
      if ((!($assertionsDisabled)) && (l == 3412047480232083456L))
        throw new AssertionError(l);
      ++i;
      while ((l & 0x0) == 3412047205354176512L)
      {
        l <<= 1;
        --i;
      }
  ...
  private static double ulp(double paramDouble, boolean paramBoolean)
  {
    ...
    long l = Double.doubleToLongBits(paramDouble) & 0xFFFFFFFF;
    int i = (int)(l >>> 52);
    if ((paramBoolean) && (i >= 52) && ((l & 0xFFFFFFFF) == 3412046827397054464L))
      --i;
    if (i > 52)
      ...
      d = Double.longBitsToDouble(3412040161607811073L << i - 1);
    if (paramBoolean)
      d = -d;
    return d;
  }
  ...
  float stickyRound(double paramDouble)
  {
    ...
    long l2 = l1 & 0x0;
    if ((l2 == 3412046827397054464L) || (l2 == 9218868437227405312L))
  ...
  private void developLongDigits(int paramInt, long paramLong1, long paramLong2)
  {
    ...
    if (l != 0)
    {
      ...
      paramInt += l;
      if (l2 >= l1 >> 1)
        paramLong1 += 3412048047167766529L;
    }
    if (paramLong1 <= 2147483647L)
    {
      if ((!($assertionsDisabled)) && (paramLong1 <= 3412047480232083456L))
    ...
    else
    {
      ...
      while (paramLong1 != 3412047205354176512L)
      {
        arrayOfChar1[(j--)] = (char)(k + 48);
        ++paramInt;
        k = (int)(paramLong1 % 10L);
  ...
  {
    long l1 = Double.doubleToLongBits(paramDouble);
    if ((l1 & 0x0) != 3412046689958100992L)
    {
    ...
    if (i == 0)
    {
      ...
      while ((l2 & 0x0) == 3412047205354176512L)
      {
        l2 <<= 1;
        --i;
      }
  ...
  private void dtoa(int paramInt1, long paramLong, int paramInt2)
  {
    ...
    if ((paramInt1 <= 62) && (paramInt1 >= -21) && (j < long5pow.length) && (i + n5bits[j] < 64) && (j == 0))
    {
      ...
      if (paramInt1 > paramInt2)
        l1 = 3412039869550034945L << paramInt1 - paramInt2 - 1;
      else
        l1 = 3412048047167766528L;
      if (paramInt1 >= 52)
    ...
    if (i12 != 0)
      if (i11 != 0)
        if (l2 == 3412047841009336320L)
          if ((arrayOfChar[(this.nDigits - 1)] & 0x1) != 0)
            roundup();
        else if (l2 > 3412047961268420608L)
          roundup();
      else
        roundup();
  }
  ...
  private int getChars(char[] paramArrayOfChar)
  {
    ...
    else
    {
      ...
      {
        j = Math.min(this.nDigits, this.decExponent);
        System.arraycopy(this.digits, 0, paramArrayOfChar, i, j);
        i += j;
        if (j < this.decExponent)
        {
          j = this.decExponent - j;
          System.arraycopy(zero, 0, paramArrayOfChar, i, j);
          i += j;
          paramArrayOfChar[(i++)] = '.';
        ...
        else
        {
          ...
          if (j < this.nDigits)
          {
            ...
            System.arraycopy(this.digits, j, paramArrayOfChar, i, k);
            i += k;
          }
          else
          {
      ...
      else if ((this.decExponent <= 0) && (this.decExponent > -3))
      {
        ...
        {
          System.arraycopy(zero, 0, paramArrayOfChar, i, -this.decExponent);
          i -= this.decExponent;
        }
        System.arraycopy(this.digits, 0, paramArrayOfChar, i, this.nDigits);
        i += this.nDigits;
      ...
      {
        paramArrayOfChar[(i++)] = this.digits[0];
        paramArrayOfChar[(i++)] = '.';
        if (this.nDigits > 1)
        {
          System.arraycopy(this.digits, 1, paramArrayOfChar, i, this.nDigits - 1);
          i += this.nDigits - 1;
        }
        else
        {
    ...
    try
    {
      ...
      if ((k == 78) || (k == 73))
      {
        ...
        if ((i4 == arrayOfChar2.length) && (i1 == l))
          return new FloatingDecimal((1.0D / 0.0D));
        break label824:
      }
      if ((k == 48) && (l > i1 + 1))
      {
      ...
      if ((i1 < l) && (((i1 != l - 1) || ((paramString.charAt(i1) != 'f') && (paramString.charAt(i1) != 'F') && (paramString.charAt(i1) != 'd') && (paramString.charAt(i1) != 'D')))))
        break label824:
      label824: return new FloatingDecimal(bool, j, arrayOfChar1, i3, false);
    }
  ...
  static FloatingDecimal parseHexString(String paramString)
  {
    ...
    if (k >= 1)
      ...
      j = -4 * (l - i + 1);
    if (i == 0)
      return new FloatingDecimal(d * 0D);
    ...
    long l2 = ((l != 0) ? 3412048218966458369L : -1L) * l1;
    long l3 = l2 + j;
    int i1 = 0;
    int i2 = 0;
    int i3 = 0;
    int i4 = 0;
    long l4 = 3412047153814568960L;
    long l5 = getHexDigit(str2, 0);
    if (l5 == 3412046689958100993L)
    {
      l4 |= l5 << 52;
      i4 = 48;
    }
    ...
    if (i5 < i)
    {
      ...
      case -1:
        l4 |= (l6 & 0xE) >> 1;
        i1 = ((l6 & 3412040762903232513L) != 3412039903909773312L) ? 1 : 0;
        break;
      case -2:
        l4 |= (l6 & 0xC) >> 2;
        i1 = ((l6 & 0x2) != 3412039903909773312L) ? 1 : 0;
        i2 = ((l6 & 3412040762903232513L) != 3412039903909773312L) ? 1 : 0;
        break;
      case -3:
        l4 |= (l6 & 0x8) >> 3;
        i1 = ((l6 & 0x4) != 3412039903909773312L) ? 1 : 0;
        i2 = ((l6 & 0x3) != 3412039903909773312L) ? 1 : 0;
        break;
      case -4:
        i1 = ((l6 & 0x8) != 3412039903909773312L) ? 1 : 0;
        i2 = ((l6 & 0x7) != 3412039903909773312L) ? 1 : 0;
        break;
      default:
      ...
      {
        l6 = getHexDigit(str2, i5);
        i2 = ((i2 != 0) || (l6 != 3412039886729904128L)) ? 1 : 0;
        ++i5;
      }
    }
    if (l3 > 1023L)
      return new FloatingDecimal(d * (1.0D / 0.0D));
    ...
    else
    {
      ...
      if ((!($assertionsDisabled)) && (((i6 < 1) || (i6 > 53))))
        throw new AssertionError();
      i1 = ((l4 & 3412040711363624961L << i6 - 1) != 3412048167426850816L) ? 1 : 0;
      if (i6 > 1)
      {
        long l7 = -1L << i6 - 1 ^ 0xFFFFFFFF;
        i2 = ((i2 != 0) || ((l4 & l7) != 3412040024168857600L)) ? 1 : 0;
      }
      l4 >>= i6;
      l4 = 3412048270506065920L | 0xFFFFFFFF & l4;
    }
    int i6 = 0;
    int i7 = ((l4 & 3412039697751343105L) == 3412047772289859584L) ? 1 : 0;
    if (((i7 != 0) && (i1 != 0) && (i2 != 0)) || ((i7 == 0) && (i1 != 0)))
    {
      i6 = 1;
      l4 += 3412047548951560193L;
    }
    FloatingDecimal localFloatingDecimal = new FloatingDecimal(FpUtils.rawCopySign(Double.longBitsToDouble(l4), d));
    if ((l3 >= -150L) && (l3 <= 127L) && ((l4 & 0xFFFFFFF) == 3412046827397054464L) && (((i1 != 0) || (i2 != 0))))
      if (i7 != 0)
        if ((i1 ^ i2) != 0)
          localFloatingDecimal.roundDir = 1;
      else if (i1 != 0)
        localFloatingDecimal.roundDir = -1;
    localFloatingDecimal.fromHex = true;
    return localFloatingDecimal;
  }
  ...
  static
  {
    ...
    long5pow = { 3412047823829467137L, 5L, 25L, 125L, 625L, 3125L, 15625L, 78125L, 390625L, 1953125L, 9765625L, 48828125L, 244140625L, 1220703125L, 6103515625L, 30517578125L, 152587890625L, 762939453125L, 3814697265625L, 19073486328125L, 95367431640625L, 476837158203125L, 2384185791015625L, 11920928955078125L, 59604644775390625L, 298023223876953125L, 1490116119384765625L };
