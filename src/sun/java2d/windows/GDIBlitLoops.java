...
public class GDIBlitLoops extends Blit
{
  ...
  {
    nativeBlit(paramSurfaceData1, paramSurfaceData2, paramRegion, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, this.rmask, this.gmask, this.bmask, this.indexed);
  }
}