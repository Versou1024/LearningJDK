...
class PixelWriterDrawHandler extends ProcessPath.DrawHandler
{
  ...
  {
    GeneralRenderer.doDrawLine(this.sData, this.pw, null, this.clip, paramInt1, paramInt2, paramInt3, paramInt4);
  }

  public void drawPixel(int paramInt1, int paramInt2)
  {
    GeneralRenderer.doSetRect(this.sData, this.pw, paramInt1, paramInt2, paramInt1 + 1, paramInt2 + 1);
  }

  public void drawScanline(int paramInt1, int paramInt2, int paramInt3)
  {
    GeneralRenderer.doSetRect(this.sData, this.pw, paramInt1, paramInt3, paramInt2 + 1, paramInt3 + 1);
  }
}