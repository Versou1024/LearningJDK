...
public final class SurfaceType
{
  ...
  public static final synchronized int makeUniqueID(String paramString)
  {
    ...
    if (localInteger == null)
    {
      ...
      localInteger = new Integer(unusedUID++);
  ...
  {
    return this.pixelConverter.rgbToPixel(paramInt, paramColorModel);
  }

  public int rgbFor(int paramInt, ColorModel paramColorModel)
  {
    return this.pixelConverter.pixelToRgb(paramInt, paramColorModel);
  }
  ...
  public boolean equals(Object paramObject)
  {
    if (paramObject instanceof SurfaceType)
      return (((SurfaceType)paramObject).uniqueID == this.uniqueID);
    return false;
  }
