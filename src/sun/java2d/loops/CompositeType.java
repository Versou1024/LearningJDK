...
public final class CompositeType
{
  ...
  public static CompositeType forAlphaComposite(AlphaComposite paramAlphaComposite)
  {
    ...
    case 1:
      return Clear;
    case 2:
      if (paramAlphaComposite.getAlpha() >= 1F)
        return SrcNoEa;
      return Src;
    case 9:
      return Dst;
  ...
  public boolean isDerivedFrom(CompositeType paramCompositeType)
  {
    ...
    do
    {
      if (localCompositeType.desc == paramCompositeType.desc)
        return true;
      localCompositeType = localCompositeType.next;
    }
  ...
  public boolean equals(Object paramObject)
  {
    if (paramObject instanceof CompositeType)
      return (((CompositeType)paramObject).uniqueID == this.uniqueID);
    return false;
  }
