  ...
  implements Cloneable
{
  ...
  {
    return "FontInfo[font=" + this.font + ", " + "devTx=" + mtx(this.devTx) + ", " + "glyphTx=" + mtx(this.glyphTx) + ", " + "pixelHeight=" + this.pixelHeight + ", " + "origin=(" + this.originX + "," + this.originY + "), " + "aaHint=" + this.aaHint + ", " + "lcdRGBOrder=" + ((this.lcdRGBOrder) ? "RGB" : "BGR") + "lcdSubPixPos=" + this.lcdSubPixPos + "]";
  }
}