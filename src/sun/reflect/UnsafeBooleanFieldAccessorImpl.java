...
class UnsafeBooleanFieldAccessorImpl extends UnsafeFieldAccessorImpl
{
    ...
    throws IllegalArgumentException
  {
    ...
    return unsafe.getBoolean(paramObject, this.fieldOffset);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    {
      unsafe.putBoolean(paramObject1, this.fieldOffset, ((Boolean)paramObject2).booleanValue());
      return;
    }
    throwSetIllegalArgumentException(paramObject2);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    unsafe.putBoolean(paramObject, this.fieldOffset, paramBoolean);
  }
