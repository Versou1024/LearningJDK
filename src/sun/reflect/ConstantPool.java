...
public class ConstantPool
{
  ...
  {
    return getClassAt0(this.constantPoolOop, paramInt);
  }

  public Class getClassAtIfLoaded(int paramInt)
  {
    return getClassAtIfLoaded0(this.constantPoolOop, paramInt);
  }

  public Member getMethodAt(int paramInt)
  {
    return getMethodAt0(this.constantPoolOop, paramInt);
  }

  public Member getMethodAtIfLoaded(int paramInt)
  {
    return getMethodAtIfLoaded0(this.constantPoolOop, paramInt);
  }

  public Field getFieldAt(int paramInt)
  {
    return getFieldAt0(this.constantPoolOop, paramInt);
  }

  public Field getFieldAtIfLoaded(int paramInt)
  {
    return getFieldAtIfLoaded0(this.constantPoolOop, paramInt);
  }

  public String[] getMemberRefInfoAt(int paramInt)
  {
    return getMemberRefInfoAt0(this.constantPoolOop, paramInt);
  }

  public int getIntAt(int paramInt)
  {
    return getIntAt0(this.constantPoolOop, paramInt);
  }

  public long getLongAt(int paramInt)
  {
    return getLongAt0(this.constantPoolOop, paramInt);
  }

  public float getFloatAt(int paramInt)
  {
    return getFloatAt0(this.constantPoolOop, paramInt);
  }

  public double getDoubleAt(int paramInt)
  {
    return getDoubleAt0(this.constantPoolOop, paramInt);
  }

  public String getStringAt(int paramInt)
  {
    return getStringAt0(this.constantPoolOop, paramInt);
  }

  public String getUTF8At(int paramInt)
  {
    return getUTF8At0(this.constantPoolOop, paramInt);
  }
