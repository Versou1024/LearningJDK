...
class UnsafeQualifiedByteFieldAccessorImpl extends UnsafeQualifiedFieldAccessorImpl
{
    ...
    throws IllegalArgumentException
  {
    ...
    return unsafe.getByteVolatile(paramObject, this.fieldOffset);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    {
      unsafe.putByteVolatile(paramObject1, this.fieldOffset, ((Byte)paramObject2).byteValue());
      return;
    }
    throwSetIllegalArgumentException(paramObject2);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    unsafe.putByteVolatile(paramObject, this.fieldOffset, paramByte);
  }
