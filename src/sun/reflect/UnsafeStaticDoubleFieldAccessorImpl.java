...
class UnsafeStaticDoubleFieldAccessorImpl extends UnsafeStaticFieldAccessorImpl
{
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    {
      unsafe.putDouble(this.base, this.fieldOffset, ((Byte)paramObject2).byteValue());
      return;
    }
    if (paramObject2 instanceof Short)
    {
      unsafe.putDouble(this.base, this.fieldOffset, ((Short)paramObject2).shortValue());
      return;
    }
    if (paramObject2 instanceof Character)
    {
      unsafe.putDouble(this.base, this.fieldOffset, ((Character)paramObject2).charValue());
      return;
    }
    if (paramObject2 instanceof Integer)
    {
      unsafe.putDouble(this.base, this.fieldOffset, ((Integer)paramObject2).intValue());
      return;
    }
    if (paramObject2 instanceof Long)
    {
      unsafe.putDouble(this.base, this.fieldOffset, ((Long)paramObject2).longValue());
      return;
    }
    if (paramObject2 instanceof Float)
    {
      unsafe.putDouble(this.base, this.fieldOffset, ((Float)paramObject2).floatValue());
      return;
    }
    if (paramObject2 instanceof Double)
    {
      unsafe.putDouble(this.base, this.fieldOffset, ((Double)paramObject2).doubleValue());
      return;
    }
    throwSetIllegalArgumentException(paramObject2);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    unsafe.putDouble(this.base, this.fieldOffset, paramDouble);
  }
}