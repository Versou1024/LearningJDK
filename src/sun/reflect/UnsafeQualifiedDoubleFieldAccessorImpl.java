...
class UnsafeQualifiedDoubleFieldAccessorImpl extends UnsafeQualifiedFieldAccessorImpl
{
    ...
    throws IllegalArgumentException
  {
    ...
    return unsafe.getDoubleVolatile(paramObject, this.fieldOffset);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    {
      unsafe.putDoubleVolatile(paramObject1, this.fieldOffset, ((Byte)paramObject2).byteValue());
      return;
    }
    if (paramObject2 instanceof Short)
    {
      unsafe.putDoubleVolatile(paramObject1, this.fieldOffset, ((Short)paramObject2).shortValue());
      return;
    }
    if (paramObject2 instanceof Character)
    {
      unsafe.putDoubleVolatile(paramObject1, this.fieldOffset, ((Character)paramObject2).charValue());
      return;
    }
    if (paramObject2 instanceof Integer)
    {
      unsafe.putDoubleVolatile(paramObject1, this.fieldOffset, ((Integer)paramObject2).intValue());
      return;
    }
    if (paramObject2 instanceof Long)
    {
      unsafe.putDoubleVolatile(paramObject1, this.fieldOffset, ((Long)paramObject2).longValue());
      return;
    }
    if (paramObject2 instanceof Float)
    {
      unsafe.putDoubleVolatile(paramObject1, this.fieldOffset, ((Float)paramObject2).floatValue());
      return;
    }
    if (paramObject2 instanceof Double)
    {
      unsafe.putDoubleVolatile(paramObject1, this.fieldOffset, ((Double)paramObject2).doubleValue());
      return;
    }
    throwSetIllegalArgumentException(paramObject2);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    unsafe.putDoubleVolatile(paramObject, this.fieldOffset, paramDouble);
  }
}