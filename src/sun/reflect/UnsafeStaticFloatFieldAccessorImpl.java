...
class UnsafeStaticFloatFieldAccessorImpl extends UnsafeStaticFieldAccessorImpl
{
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    {
      unsafe.putFloat(this.base, this.fieldOffset, ((Byte)paramObject2).byteValue());
      return;
    }
    if (paramObject2 instanceof Short)
    {
      unsafe.putFloat(this.base, this.fieldOffset, ((Short)paramObject2).shortValue());
      return;
    }
    if (paramObject2 instanceof Character)
    {
      unsafe.putFloat(this.base, this.fieldOffset, ((Character)paramObject2).charValue());
      return;
    }
    if (paramObject2 instanceof Integer)
    {
      unsafe.putFloat(this.base, this.fieldOffset, ((Integer)paramObject2).intValue());
      return;
    }
    if (paramObject2 instanceof Long)
    {
      unsafe.putFloat(this.base, this.fieldOffset, (float)((Long)paramObject2).longValue());
      return;
    }
    if (paramObject2 instanceof Float)
    {
      unsafe.putFloat(this.base, this.fieldOffset, ((Float)paramObject2).floatValue());
      return;
    }
    throwSetIllegalArgumentException(paramObject2);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    unsafe.putFloat(this.base, this.fieldOffset, paramFloat);
  }
