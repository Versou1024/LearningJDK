...
class UnsafeQualifiedShortFieldAccessorImpl extends UnsafeQualifiedFieldAccessorImpl
{
    ...
    throws IllegalArgumentException
  {
    ...
    return unsafe.getShortVolatile(paramObject, this.fieldOffset);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    {
      unsafe.putShortVolatile(paramObject1, this.fieldOffset, (short)((Byte)paramObject2).byteValue());
      return;
    }
    if (paramObject2 instanceof Short)
    {
      unsafe.putShortVolatile(paramObject1, this.fieldOffset, ((Short)paramObject2).shortValue());
      return;
    }
    throwSetIllegalArgumentException(paramObject2);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    unsafe.putShortVolatile(paramObject, this.fieldOffset, paramShort);
  }
