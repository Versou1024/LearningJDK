...
class UnsafeQualifiedFloatFieldAccessorImpl extends UnsafeQualifiedFieldAccessorImpl
{
    ...
    throws IllegalArgumentException
  {
    ...
    return unsafe.getFloatVolatile(paramObject, this.fieldOffset);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    {
      unsafe.putFloatVolatile(paramObject1, this.fieldOffset, ((Byte)paramObject2).byteValue());
      return;
    }
    if (paramObject2 instanceof Short)
    {
      unsafe.putFloatVolatile(paramObject1, this.fieldOffset, ((Short)paramObject2).shortValue());
      return;
    }
    if (paramObject2 instanceof Character)
    {
      unsafe.putFloatVolatile(paramObject1, this.fieldOffset, ((Character)paramObject2).charValue());
      return;
    }
    if (paramObject2 instanceof Integer)
    {
      unsafe.putFloatVolatile(paramObject1, this.fieldOffset, ((Integer)paramObject2).intValue());
      return;
    }
    if (paramObject2 instanceof Long)
    {
      unsafe.putFloatVolatile(paramObject1, this.fieldOffset, (float)((Long)paramObject2).longValue());
      return;
    }
    if (paramObject2 instanceof Float)
    {
      unsafe.putFloatVolatile(paramObject1, this.fieldOffset, ((Float)paramObject2).floatValue());
      return;
    }
    throwSetIllegalArgumentException(paramObject2);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    unsafe.putFloatVolatile(paramObject, this.fieldOffset, paramFloat);
  }
